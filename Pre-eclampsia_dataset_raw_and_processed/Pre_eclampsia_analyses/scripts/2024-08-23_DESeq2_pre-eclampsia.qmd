...
# I have a persistent issue here with values that are around 300 centering on 0 in the plot. Apparently, this is a function of how Plotly handles KDE bandwidth, but this is  


plot_violin_log2_counts
```
...
```{r}
norm_counts <- counts(my_DESeqGene_result, normalized = TRUE)
```
